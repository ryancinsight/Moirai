...
pub use ops::{
    ...
    for_each_unit_task_mut_with, for_each_unit_task_pair_mut_with, for_each_with, join, join_with,
    map_collect_index_with, map_collect_mut_with, map_collect_with, map_reduce_with,
    reduce_index_with, scope, units_per_task,
};
