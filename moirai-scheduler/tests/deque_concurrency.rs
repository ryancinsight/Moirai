...
//! discipline (Lê, Pop, Cohen & Nardelli, PPoPP 2013); the matching bounded
//! `loom` model checks of the steal/pop ordering and resize-exclusion protocols
//! live in `tests/loom_chase_lev*.rs` (run with
//! `RUSTFLAGS="--cfg loom"`).
//!
