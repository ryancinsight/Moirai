...
cargo bench -p moirai-benchmarks --bench iterator_adapter_comparison -- "iterator_adapter_(indexed|filter_flat|flatten|take_skip_any|update|intersperse|try_reduce|terminal_reducers|find_map|position|ref_copy_clone|non_clone_ref_map|unzip)" --quiet
