...
- **Integrator:** root (takeover 2026-09-16); **branch:** `perf/executor-sizing-diagnostic-harness`; **regions:** `moirai-executor` queue/runtime and Loom regression models; the caller-help fix is withdrawn pending its crash.
