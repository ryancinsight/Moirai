...
- Status: review; implementation: `aa65267f`; PRs: [#387](https://github.com/ryancinsight/Moirai/pull/387), [#388](https://github.com/ryancinsight/Moirai/pull/388); merge: `617b55a99360a2d50ed0007ea918b8ba20305245`; last-update: 2026-09-16.
...
- Delivery correction: the PR reports head `cf4affe86e4fa57ff40db26548bebbfd249896de`; a manually reconstructed invalid SHA caused the first consumer fetch to fail. PR #387 merged administratively while fresh hosted checks were running, outside the unavailable-or-starved-CI exception. Hosted run [35176859540](https://github.com/ryancinsight/Moirai/actions/runs/35176859540) exposed a stale benchmark source contract left by PR #386; PR #388 updates it at `a3a0ae1400a400046b62d9bf0f40b150d7e02141`. The configured local workspace gate passes format, warning-denied all-feature Clippy and rustdoc, 1117/1117 nextest cases with 10 configured skips, and all-feature doctests; fresh hosted verification remains the merge gate.
