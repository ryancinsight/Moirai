...
## ADR-023 (2026-07-26): Delete `moirai-iter`'s ThreadPool

- Status: Accepted [major] · Refs: ISSUE-222, ADR-022
...
## ADR-025 (2026-07-27): Producer and Consumer roles, and a cached opposite index

- Status: Accepted [arch] [minor] · Refs: ADR-024, PR #108
...
## ADR-027 (2026-08-14): Facade NUMA policy reaches scheduler construction

- Status: Accepted [arch] [minor]
