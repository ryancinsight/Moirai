...
Latest native audit refresh: Moirai ready result handles measured 544.01-571.75 ns versus Tokio 1.3583-1.6227 us, Moirai single scope measured 534.89-543.65 ns versus Rayon 632.16-637.41 ns, Moirai mixed unified work measured 39.666-40.156 us versus Tokio plus Rayon 51.772-53.105 us, Moirai real-application mixed work measured 89.559-90.721 us versus Tokio plus Rayon 106.88-108.04 us, Moirai indexed source cardinality measured 1.8682-1.8871 ns versus Rayon 1.8668-1.8727 ns, Moirai indexed `collect_into_vec` measured 54.745-75.638 us versus Rayon 95.255-102.59 us, Moirai indexed `unzip_into_vecs` measured 256.72-273.34 us versus Rayon 268.81-303.00 us, Moirai indexed `interleave`/`interleave_shortest` measured 401.13-439.28 us versus Rayon 433.44-453.31 us, Moirai indexed `step_by` measured 24.335-25.830 us versus Rayon 65.191-67.990 us, Moirai indexed block adapters measured 30.128-32.300 us versus Rayon 4.4301-4.5698 ms, Moirai `collect_vec_list` measured 18.349-18.558 us versus Rayon 315.88-327.29 us, Moirai serial-inner `filter_map`/`flat_map_iter` measured 79.134-123.35 us versus Rayon 393.06-405.26 us, Moirai serial-inner `flatten_iter` measured 73.234-74.541 us versus Rayon 150.08-155.19 us, Moirai `zip_eq` measured 107.34-142.67 us versus Rayon 364.99-373.05 us, Moirai `partition_map` measured 32.468-32.719 us versus Rayon 587.36-620.15 us, Moirai `try_reduce_with` measured 8.5426-8.7513 us versus Rayon 64.753-66.248 us, Moirai `positions` measured 11.248-11.339 us versus Rayon 234.78-239.80 us, Moirai `take_any_while`/`skip_any_while` measured 91.813-102.11 us versus Rayon 729.10-756.49 us on the full-pass predicate-window row, the borrowed non-Clone `Vec<T>::par_iter` row measured 16.446-17.165 us versus Rayon 57.328-79.918 us, the scoped `iter_ops::ParallelIter` helper measured map at 7.0830-7.5290 us versus Rayon 46.176-47.066 us plus reduce at 1.7471-1.7582 us versus Rayon 47.637-50.345 us, the borrowed `ZeroCopyParallelIter` helper measured map at 422.36-444.66 ns versus Rayon 101.42-289.01 us, reduce at 297.25-303.37 ns versus Rayon 64.054-165.09 us, and large reduce at 4.0282-4.1575 us versus Rayon 67.143-83.126 us, the owned execution-context helper measured map at 120.53-122.07 ns versus Rayon 29.323-30.104 us, the owned NUMA-context helper measured map at 175.50-204.96 ns versus Rayon 45.097-142.69 us, the owned distributed-context helper measured map at 389.05-428.30 ns versus Rayon 72.092-75.365 us, and the owned multi-system-context helper measured map at 348.11-354.81 ns versus Rayon 61.837-78.097 us. The refreshed async iterator and selected Rayon adapter rows also remain closed for the documented audited subset.
...
| Utility SIMD vector prefix/tail | 11.811-11.860 ns (65), 244.48-319.91 ns (4,099), 1.0971-1.2375 us (16,385) | Scalar 52.163-54.634 ns, 3.4960-3.5928 us, 13.490-13.877 us | Zero-cost utility invariant row; not a Rayon/Tokio competitive comparison |
...
| Iterator collect-vec-list | 18.349-18.558 us | Rayon 315.88-327.29 us | `iterator_adapter_collect_vec_list` asserts equal flattened `(len, sum, xor)` summaries before timing and unit tests cover non-`Clone` movement plus empty-list behavior |
