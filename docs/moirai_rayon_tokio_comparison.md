...
| Standalone deque reclamation historical baseline | 2.1955-2.2040 us | Shared epoch policy 6.3355-6.4715 us | Superseded exclusive-reclaim surface; ADR-020 requires a refreshed `DeferredReclaim` endpoint measurement |
