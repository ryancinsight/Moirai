...
Latest native audit refresh: Moirai ready result handles measured 544.01-571.75 ns versus Tokio 1.3583-1.6227 us, Moirai single scope measured 534.89-543.65 ns versus Rayon 632.16-637.41 ns, Moirai mixed unified work measured 39.666-40.156 us versus Tokio plus Rayon 51.772-53.105 us, Moirai real-application mixed work measured 89.559-90.721 us versus Tokio plus Rayon 106.88-108.04 us, Moirai indexed source cardinality measured 1.8682-1.8871 ns versus Rayon 1.8668-1.8727 ns, the scoped `iter_ops::ParallelIter` helper measured map at 7.0830-7.5290 us versus Rayon 46.176-47.066 us plus reduce at 1.7471-1.7582 us versus Rayon 47.637-50.345 us, and the borrowed `ZeroCopyParallelIter` helper measured map at 422.36-444.66 ns versus Rayon 101.42-289.01 us plus reduce at 297.25-303.37 ns versus Rayon 64.054-165.09 us. The refreshed async iterator and selected Rayon adapter rows also remain closed for the documented audited subset.
