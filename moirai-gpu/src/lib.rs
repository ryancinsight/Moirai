...
pub mod prelude {
    ...
    pub use crate::{
        ConfiguredGpuTask, DevicePreferences, FunctionGpuTask, GpuContext, GpuError, GpuResult,
        GpuTask, GpuTaskBuilder, KernelResourceBudget, LaunchShape, plan_launch,
        plan_persistent_launch, resident_blocks,
    };
}
